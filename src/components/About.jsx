import './About.css'
import about from '../assets/undraw/about.svg'
import aboutRight from '../assets/undraw/about-right.svg'
const About = () => {
  return (
    <>
    
    <div id='features' className='p-5'>
        <h1 className='text-center p-5'>Haqqimizda</h1>
   
    <section class="section padding-top-70 padding-bottom-0" id="features">
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-12 col-sm-12 align-self-center" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                    <img src={about} class="rounded img-fluid d-block mx-auto" alt="App" />
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 col-md-12 col-sm-12 align-self-center mobile-bottom-fix-big" data-scroll-reveal="enter right move 30px over 0.6s after 0.4s">
                    <img src={aboutRight} class="rounded img-fluid d-block mx-auto" alt="App" />
                </div>
            </div>
        </div>
    </section>
